describe("SearchUIHotelsDetailImagesView", function() {
	"use strict";
	...
	beforeEach(function() {
		...
		require([
			...
			], function(Backbone, Marionette, SearchUIHotelsDetailImagesView) {

			that.view = new SearchUIHotelsDetailImagesView();
